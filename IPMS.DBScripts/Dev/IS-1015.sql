GO
alter table OtherServiceRecording add IsCompleted char
GO
ALTER PROCEDURE [dbo].[usp_MobileTaskAcknowledgement]
		   ...
		   select 	 VC.VesselCallid ResourceAllocationID,
             ...
             AS 'DueHours',
                ...
                left join RevenuePostingDtl RPD on RPD.vcn = VC.VCN  
                                                              ...
                                                              and rpd.MaterialCode = M.MaterialCode 
                left join RevenuePosting RP ON RP.RevenuePostingID = RPD.RevenuePostingID    
                WHERE VC.BreakWaterIn IS NOT NULL  AND VC.VCN  =  @VCN
				) a where DueHours > 0 
            ...
            '' as MovementType,a.OperationType as ServiceType,
             '' as ServiceReferenceType,a.OperationType as OperationType, '' as TaskStatus,
                ...
                WHEN (a.OperationType = 'WTST')
                   THEN (select isnull(sum(oth.TotalDispensed),0)
						from OtherServiceRecording oth,dbo.SuppServiceRequest sup 
						 where oth.ResourceAllocationID = a.ResourceAllocationID
						and sup.SuppServiceRequestID = a.ServiceReferenceID 
