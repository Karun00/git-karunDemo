ALTER PROCEDURE [dbo].[usp_VesselAgentChange_GetVCNDetails]
 @PortCode Varchar(10)     ,
 @CurrentAgentID INT
AS
BEGIN
               ...
               UNION 
						...
						--s2.SubCatName as ReasonForVisitName,
                           ...
                           Where Vc.VCN in(
                                  ...
                                  where (WorkflowTaskCode = 'REJ' OR WorkflowTaskCode = 'WFRE') and vag.VesselAgentChangeID = (select max(v1.VesselAgentChangeID) from VesselAgentChange v1 where v1.VCN = vag.VCN) and vag.CurrentAgentID = @CurrentAgentID
                           	)  AND VC.ATD IS NULL
              )x 
END
GO
