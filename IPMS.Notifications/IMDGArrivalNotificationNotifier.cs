...
namespace IPMS.Notifications
{
    public class IMDGArrivalNotificationNotifier : Notifier
    {
        ...
        public IMDGArrivalNotificationNotifier(Notification pendingNotification, NotificationTemplate notificationTemplate, Entity entityDetails, List<NotificationRole> roles)
