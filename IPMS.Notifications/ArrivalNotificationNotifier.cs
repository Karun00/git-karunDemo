...
namespace IPMS.Notifications
{
    public class ArrivalNotificationNotifier : Notifier
    {
        ...
        public ArrivalNotificationNotifier(Notification pendingNotification, NotificationTemplate notificationTemplate, Entity entityDetails, List<NotificationRole> roles)
