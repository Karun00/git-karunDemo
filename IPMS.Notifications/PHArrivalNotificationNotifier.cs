...
namespace IPMS.Notifications
{
    public class PHArrivalNotificationNotifier : Notifier
    {
        ...
        public PHArrivalNotificationNotifier(Notification pendingNotification, NotificationTemplate notificationTemplate, Entity entityDetails, List<NotificationRole> roles)
