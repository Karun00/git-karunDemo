...
namespace IPMS.Notifications
{
    public class UserRegistrationNotifier : Notifier
    {
        ...
        public UserRegistrationNotifier(Notification pendingNotification, NotificationTemplate notificationTemplate, Entity entityDetails, List<NotificationRole> roles)
            : base(pendingNotification, notificationTemplate, entityDetails, roles)
        {
            try
            {
                ...
                _userRegistration = _userRepository.GetUserByID(Convert.ToInt32(pendingNotification.Reference));
