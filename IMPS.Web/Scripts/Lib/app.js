...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
            ...
            if (sub.is(":visible")) {
                ...
                jQuery(this).parent().addClass("open");  // open to active
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            ...
            $('#style_color').attr("href", "Content/Styles/themes/" + color_ + ".css");
    ...
    return {
        ...
        init: function () {
            ...
            //// var url = $(obj).attr('href').substr($(obj).attr('href').lastIndexOf("/") +1);
