...
[assembly: WebActivator.PreApplicationStartMethod(typeof(IPMS.Web.App_Start.SimpleMembershipMvc3), "Start")]
[assembly: WebActivator.PostApplicationStartMethod(typeof(IPMS.Web.App_Start.SimpleMembershipMvc3), "Initialize")]
	...
	public static class SimpleMembershipMvc3
	{
        ...
        public static void Initialize()
        {
            ...
            if (!WebSecurity.Initialized)
                WebSecurity.InitializeDatabaseConnection(connectionStringName: "TnpaContext", userTableName: "User", userIdColumn: "UserId", userNameColumn: "UserName", autoCreateTables: true);
