...
{
    public class IMDGArrivalNotificationNotifier : Notifier
    {
        ...
        public IMDGArrivalNotificationNotifier(Notification pendingNotification, NotificationTemplateVO notificationTemplate, Entity entityDetails, List<NotificationRole> roles)
            : base(pendingNotification, notificationTemplate, entityDetails, roles)
        {
            try
            {
                XmlConfigurator.Configure();
                log = LogManager.GetLogger(typeof(IMDGArrivalNotificationNotifier));
        ...
        public override List<User> GetUsersToBeNotified()
        {
            ...
            foreach (var role in this.roles)
            {
                ...
                {
                    //ALREADY SENDING EMAIL IN ABOVE CONDITION
                }
