...
namespace IPMS.Notifications.Engine
{
    public class ISPSArrivalNotificationNotifier : Notifier
    {
        ...
        public ISPSArrivalNotificationNotifier(Notification pendingNotification, NotificationTemplateVO notificationTemplate, Entity entityDetails, List<NotificationRole> roles)
