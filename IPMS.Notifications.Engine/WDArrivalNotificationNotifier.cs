...
{
    public class WDArrivalNotificationNotifier : Notifier
    {
        ...
        public WDArrivalNotificationNotifier(Notification pendingNotification, NotificationTemplateVO notificationTemplate, Entity entityDetails, List<NotificationRole> roles)
            : base(pendingNotification, notificationTemplate, entityDetails, roles)
        {
            try
            {
                ...
                log = LogManager.GetLogger(typeof(WDArrivalNotificationNotifier));
