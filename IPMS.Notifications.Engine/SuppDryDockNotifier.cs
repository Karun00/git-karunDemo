...
namespace IPMS.Notifications.Engine
{
    public class SuppDryDockNotifier : Notifier
    {
        ...
        private ISuppDryDockRepository _suppDryDockRepository;

        public SuppDryDockNotifier(Notification pendingNotification, NotificationTemplateVO notificationTemplate, Entity entityDetails, List<NotificationRole> roles)
        ...
        public override List<User> GetUsersToBeNotified()
        {
            ...
            {
                _userslist.AddRange(_userRepository.GetUserDetailsForRoleAndPortCodeByUserType(GetPortCode(), "", "", _suppDryDock.CreatedBy));
            }
