...
{
    public class VesselArrestDocumentMap : EntityTypeConfiguration<VesselArrestDocument>
    {
        public VesselArrestDocumentMap()
        {
            // Primary Key
            ...
            this.ToTable("VesselArrestDocument");
            ...
            this.HasRequired(t => t.Document)
                .WithMany(t => t.VesselArrestDocuments)
                .HasForeignKey(d => d.DocumentID);
            this.HasRequired(t => t.User)
                .WithMany(t => t.VesselArrestDocuments)
                .HasForeignKey(d => d.CreatedBy);
            this.HasRequired(t => t.User1)
                .WithMany(t => t.VesselArrestDocuments1)
